<?php
  ...
  include 'helpers/helper_fomatos.php';
...
<html lang="es">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="../proyecto/img/slides/santorini1.jpg" class="d-block w-100" alt="...">
    ...
    <div class="carousel-item">
      <img src="../proyecto/img/slides/florencia.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block caja2" >
    ...
    <div class="carousel-item">
      <img src="../proyecto/img/slides/venecia.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block caja2">
